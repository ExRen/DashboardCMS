                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {months.map((month, idx) => (
                        <div key={idx} className="text-center">
                            ...
                            <div className="grid grid-cols-7 gap-[2px] justify-center">
                                {month.days.map((day, dayIdx) => (
                                    <div
                                        key={dayIdx}
                                        className={`w-4 h-4 rounded-sm ${day.empty ? 'bg-transparent' : getColor(day.count)} cursor-pointer transition-transform hover:scale-150`}
