...
export function Login() {
    ...
    async function handleSubmit(e) {
        ...
        if (isRegister) {
            ...
            if (result.success) {
                // Determine redirect path (ensure it starts with /)
                const target = result.redirectTo ? (result.redirectTo.startsWith('/') ? result.redirectTo : `/${result.redirectTo}`) : '/dashboard'
                navigate(target)
            } else {
